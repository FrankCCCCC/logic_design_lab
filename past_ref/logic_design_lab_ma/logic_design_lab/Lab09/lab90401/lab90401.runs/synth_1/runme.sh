...
HD_PWD='D:/data/logic_design_lab/past_ref/logic_design_lab_ma/logic_design_lab/Lab09/lab90401/lab90401.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab904.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab904.tcl
