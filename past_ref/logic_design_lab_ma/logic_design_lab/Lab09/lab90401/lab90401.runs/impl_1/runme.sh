...
HD_PWD='D:/data/logic_design_lab/past_ref/logic_design_lab_ma/logic_design_lab/Lab09/lab90401/lab90401.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab904.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab904.tcl -notrace
