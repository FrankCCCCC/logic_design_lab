...
HD_PWD='D:/data/logic_design_lab/labs/lab3/lab3_5/lab3_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_5.tcl
