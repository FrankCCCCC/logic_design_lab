...
HD_PWD='D:/data/logic_design_lab/labs/lab3/lab3_3/lab3_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_3.tcl -notrace
