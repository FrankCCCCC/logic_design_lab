...
HD_PWD='D:/data/logic_design_lab/labs/lab3/lab3_1/lab3_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frequency_divider.tcl
