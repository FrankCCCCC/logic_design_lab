...
HD_PWD='D:/data/logic_design_lab/labs/lab3/lab3_2/lab3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_2.tcl
