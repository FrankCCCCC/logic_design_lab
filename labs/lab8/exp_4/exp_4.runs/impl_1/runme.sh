...
HD_PWD='D:/data/logic_design_lab/labs/lab8/exp_4/exp_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp_4.tcl -notrace
