...
HD_PWD='D:/data/logic_design_lab/labs/lab8/exp_4/exp_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_4.tcl
