...
#
# Generated by export_simulation on Tue May 03 14:24:48 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './KeyboardCtrl_0.sh' script.

./KeyboardCtrl_0.sh -reset_run
...
./KeyboardCtrl_0.sh -noclean_files

For more information on the script, please type './KeyboardCtrl_0.sh -help'.
