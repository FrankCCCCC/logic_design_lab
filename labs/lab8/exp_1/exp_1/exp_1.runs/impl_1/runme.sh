...
HD_PWD='D:/data/logic_design_lab/labs/lab8/exp_1/exp_1/exp_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp_1.tcl -notrace
