...
HD_PWD='D:/data/logic_design_lab/labs/lab8/exp_1/exp_1/exp_1.runs/KeyboardCtrl_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardCtrl_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyboardCtrl_0.tcl
