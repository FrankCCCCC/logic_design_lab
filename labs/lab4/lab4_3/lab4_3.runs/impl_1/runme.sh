...
HD_PWD='D:/data/logic_design_lab/labs/lab4/lab4_3/lab4_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4_3.tcl -notrace
