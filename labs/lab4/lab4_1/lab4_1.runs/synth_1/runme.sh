...
HD_PWD='D:/data/logic_design_lab/labs/lab4/lab4_1/lab4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_1.tcl
