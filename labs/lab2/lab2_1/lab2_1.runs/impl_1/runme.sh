...
HD_PWD='D:/data/logic_design_lab/labs/lab2/lab2_1/lab2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_code_convertor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gray_code_convertor.tcl -notrace
