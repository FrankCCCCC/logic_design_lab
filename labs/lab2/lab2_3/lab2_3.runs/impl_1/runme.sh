...
HD_PWD='D:/data/logic_design_lab/labs/lab2/lab2_3/lab2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_3.tcl -notrace
