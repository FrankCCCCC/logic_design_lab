...
HD_PWD='D:/data/logic_design_lab/labs/lab2/lab2_3/lab2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_3.tcl
