...
HD_PWD='D:/data/logic_design_lab/labs/lab2/lab2_2/lab2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_2.tcl -notrace
