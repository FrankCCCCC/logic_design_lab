...
HD_PWD='D:/data/logic_design_lab/labs/lab2/lab2_2/lab2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_2.tcl
