...
set rc [catch {
  ...
  add_files -quiet D:/data/logic_design_lab/labs/lab6/exp_1_1/exp_1_1.runs/synth_1/exp_1.dcp
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force exp_1_physopt.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file exp_1_timing_summary_routed.rpt -pb exp_1_timing_summary_routed.pb -rpx exp_1_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file exp_1_bus_skew_routed.rpt -pb exp_1_bus_skew_routed.pb -rpx exp_1_bus_skew_routed.rpx"
