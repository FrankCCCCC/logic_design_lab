...
HD_PWD='D:/data/logic_design_lab/labs/lab6/exp_1_1/exp_1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_1_1.tcl
