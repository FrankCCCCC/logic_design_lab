...
read_verilog -library xil_defaultlib {
  ...
  D:/data/logic_design_lab/labs/lab6/exp_1_1/exp_1_1.srcs/sources_1/new/exp_1_1.v
}
...
synth_design -top exp_1_1 -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef exp_1_1.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file exp_1_1_utilization_synth.rpt -pb exp_1_1_utilization_synth.pb"
