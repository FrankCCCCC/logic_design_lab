...
HD_PWD='D:/data/logic_design_lab/labs/lab6/exp_1/exp_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log t2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source t2.tcl -notrace
