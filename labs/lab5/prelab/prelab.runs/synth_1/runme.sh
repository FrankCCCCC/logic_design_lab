...
HD_PWD='D:/data/logic_design_lab/labs/lab5/prelab/prelab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_disp.tcl
