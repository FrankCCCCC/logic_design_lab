...
HD_PWD='D:/data/logic_design_lab/labs/lab5/prelab/prelab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_disp.tcl -notrace
