...
HD_PWD='D:/data/logic_design_lab/labs/lab7/exp_2/exp_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log speaker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source speaker.tcl -notrace
