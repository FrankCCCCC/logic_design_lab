...
HD_PWD='D:/data/logic_design_lab/labs/lab7/exp_1/exp_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log speaker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source speaker.tcl
