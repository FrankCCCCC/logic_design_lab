...
HD_PWD='D:/data/logic_design_lab/final_project/final/final.runs/blk_mem_gen_bg_big_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_bg_big.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_bg_big.tcl
