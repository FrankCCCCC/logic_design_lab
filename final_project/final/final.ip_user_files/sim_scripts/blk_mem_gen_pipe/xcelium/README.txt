...
#
# Generated by export_simulation on Sat May 21 21:14:46 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_pipe.sh' script.

./blk_mem_gen_pipe.sh -reset_run
...
./blk_mem_gen_pipe.sh -noclean_files

For more information on the script, please type './blk_mem_gen_pipe.sh -help'.
