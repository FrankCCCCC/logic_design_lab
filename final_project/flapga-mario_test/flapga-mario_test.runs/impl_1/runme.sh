...
HD_PWD='D:/flapga-mario_test/flapga-mario_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flapga_mario.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flapga_mario.tcl -notrace
