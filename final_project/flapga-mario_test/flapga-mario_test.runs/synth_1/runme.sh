...
HD_PWD='D:/flapga-mario_test/flapga-mario_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flapga_mario.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flapga_mario.tcl
